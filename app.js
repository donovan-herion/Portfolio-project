...
fr.addEventListener("click", () => {
  ...
  landingPageSrc1.innerHTML =
    'Bonjour! <i class="em em-wave" aria-role="presentation" aria-label="WAVING HAND SIGN"></i>';

  landingPageSrc2.innerHTML =
    'Je suis <strong>Donovan Herion</strong><br>un développeur front-end <br> specialisé dans la construction<br>de belles interfaces<br>& expériences pour le web <i class="em em-male-technologist" aria-role="presentation" aria-label=""></i>';

  landingPageSrc3.innerHTML =
    'Contactez-moi <i class="em em-point_right" aria-role="presentation" aria-label="WHITE RIGHT POINTING BACKHAND INDEX"></i> <span>donovanherion@gmail.com</span>';
  ...
  value1.innerHTML =
    '<i class="em em-man-raising-hand" aria-role="presentation" aria-label=""></i><h4>Développement</h4><p>En tant que front end developer j\'écris le code non visible qui pourtant est primordial dans l\'élaboration d\'un site web.</p>';

  value2.innerHTML =
    '<i class="em em-pencil2" aria-role="presentation" aria-label="PENCIL"></i><h4>Design</h4><p>Le rendu final est important !<br>Le design est généralement la raison principale qui pousse un visiteur à revenir sur votre site.</p>';

  value3.innerHTML =
    '<i class="em em-gift_heart" aria-role="presentation" aria-label="HEART WITH RIBBON"></i><h4>Passion</h4><p>De nature intéressé par la technologie et les challenges, je m\'épanouis pleinement dans le domaine du developpement web.</p>';

  value4.innerHTML =
    '<i class="em em-smiley" aria-role="presentation" aria-label="SMILING FACE WITH OPEN MOUTH"></i><h4>Positivité</h4><p>Sourire est totalement gratuit pour mon plus grand bonheur mais aussi pour les personnes ayant la chance de me cotoyer au travail comme dans la vie de tous les jours !</p>';
...
en.addEventListener("click", () => {
  ...
  landingPageSrc2.innerHTML =
    'I\'m <strong>Donovan Herion</strong> a front-end <br> developer focused on building <br> beautiful interfaces <br> & experiences for the web <i class="em em-male-technologist" aria-role="presentation" aria-label=""></i>';

  landingPageSrc3.innerHTML =
    'Get in touch <i class="em em-point_right" aria-role="presentation" aria-label="WHITE RIGHT POINTING BACKHAND INDEX"></i> <span>donovanherion@gmail.com</span>';
  ...
  value1.innerHTML =
    '<i class="em em-man-raising-hand" aria-role="presentation" aria-label=""></i><h4>Development</h4><p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Consequatur, deserunt!</p>';

  value2.innerHTML =
    '<i class="em em-pencil2" aria-role="presentation" aria-label="PENCIL"></i><h4>Design</h4><p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Consequatur, deserunt!</p>';

  value3.innerHTML =
    '<i class="em em-gift_heart" aria-role="presentation" aria-label="HEART WITH RIBBON"></i><h4>Passion</h4><p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Consequatur, deserunt!</p>';

  value4.innerHTML =
    '<i class="em em-smiley" aria-role="presentation" aria-label="SMILING FACE WITH OPEN MOUTH"></i><h4>Positivism</h4><p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Consequatur, deserunt!</p>';
